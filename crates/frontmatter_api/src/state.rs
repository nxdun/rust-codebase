...
pub struct AppState {
    ...
    pub db_pool: shared_core::db::postgres::DbPool,
    /// Redis connection pool.
    pub redis_pool: shared_core::db::redis::RedisPool,
    /// Apalis job storage.
    pub storage: apalis_redis::RedisStorage<shared_core::models::ytdlp::DownloadJob>,
}
