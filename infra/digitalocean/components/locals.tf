locals {
  ...
  cloud_init = templatefile("${path.module}/../../common/cloud-init.template", {
    ...
    API_HEALTH_DASHBOARD_URL       = var.API_HEALTH_DASHBOARD_URL
    SECURITY_OVERVIEW_DASHBOARD_URL = var.SECURITY_OVERVIEW_DASHBOARD_URL
    DOMAIN_SERVICES_DASHBOARD_URL   = var.DOMAIN_SERVICES_DASHBOARD_URL
